...
export const getDocketByRecId = (recId, docketNo) => Api.get(`/docket/rec/${encodeURIComponent(recId)}?docketNo=${docketNo ? encodeURIComponent(docketNo) :''}`).then(r => r.data.data || r.data);
